...
DEFAULT_PREDICTIONS_PATH = pathlib.Path("experiments/withhrrr/data/runtime/evaluation/validation_predictions.parquet")
DEFAULT_OUTPUT_DIR = pathlib.Path("experiments/withhrrr/data/runtime/evaluation")


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fit simple empirical quantile offsets for with-HRRR final-Tmax quantiles.")
