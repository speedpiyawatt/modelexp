...
DEFAULT_CALIBRATION_PATH = pathlib.Path("experiments/no_hrrr_model/data/runtime/evaluation/calibration_selection/rolling_origin_calibration_manifest.json")
DEFAULT_DISTRIBUTION_MANIFEST_PATH = pathlib.Path("experiments/no_hrrr_model/data/runtime/evaluation/distribution_diagnostics/distribution_diagnostics_manifest.json")
