...
DEFAULT_OUTPUT_DIR = pathlib.Path("experiments/no_hrrr_model/data/runtime/polymarket")
...
def fetch_json(url: str) -> Any:
    request = urllib.request.Request(url, headers={"User-Agent": "no-hrrr-polymarket-event-fetcher/1.0", "Accept": "application/json"})
